# Collector for Portwatch Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-portwatch/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-portwatch/actions/workflows/run-python-tests.yaml)
...
This retrieves data from the PortWatch API, including Daily Port Activity and Trade Estimates, Ports, and Disruptions. It downloads all Ports and Disruptions records and publishes both CSV and GeoJSON outputs to HDX. It also queries Daily Port Activity by country and generates one CSV file per country. The scraper is scheduled to run every Tuesday.
 ...
 **hdx-scraper-portwatch** as specified in the parameter
 *user_agent_lookup*.
...
```shell
    pip install .
    python -m hdx.scraper.portwatch
```
